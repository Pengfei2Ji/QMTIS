...
! Unit 50 and 51 are for ddk files (two ddk files are needed for ipert=natom+11).
...
!   std_in=5, ab_in=5, std_out=6, ab_out=7, tmp_unit=9, tmp_unit2=10
 integer,parameter :: unchi0=42,unddb=16,unddk=50,und2dk=20,unkg1=19,unkg=17,unkgq=18
 ...
 character(len=fnlen) :: fnamewff1,fnamewffddk,fnamewffk,fnamewffq
