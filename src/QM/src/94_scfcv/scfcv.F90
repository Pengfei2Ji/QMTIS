...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2016 ABINIT group (XG, GMR, AR, MKV, MT, FJ, MB)
...
!scalars
 ...
 integer :: computed_forces,cplex,cplex_hf,ctocprj_choice,choice_hf,dbl_nnsclo,dielop,dielstrt,dimdmat
...
&         rprimd,dtset%typat,ucvol,xred,typord=1)
         choice_hf=1;iatom=-1;idir=0;useylmgr=0
         call ctocprj(atindx,cg,choice_hf,cprj,gmet,gprimd,iatom,idir,&
