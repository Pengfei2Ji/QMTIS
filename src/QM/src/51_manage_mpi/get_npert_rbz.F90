...
!Local variables-------------------------------
!scalars
 integer :: icase,idir,ikpt,ikpt1,ipert,isppol,isym,mpert,nband_k,nsym1,timrev,timrev_pert,pert
...
!Initialize the list of perturbations rfpert
 ...
 if(dtset%rf2_dkdk==1.or.dtset%rf2_dkdk==3)rfpert(dtset%natom+10)=1
 if(dtset%rf2_dkdk==2.or.dtset%rf2_dkdk==3)rfpert(dtset%natom+11)=1
...
&     dtset%berryopt==4 .or. dtset%berryopt==6 .or. dtset%berryopt==7  &
