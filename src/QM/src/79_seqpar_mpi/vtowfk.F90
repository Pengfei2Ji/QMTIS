...
!!      pawcprj_alloc,pawcprj_free,pawcprj_put,prep_fourwf,prep_nonlop
!!      pw_orthon,subdiago,timab,wrtout,xmpi_sum,zhemm
!!
!! NOTES
...
& pwind,pwind_alloc,pwnsfac,pwnsfacq,resid_k,rhoaug,paw_dmft,wtk,zshift)
 ...
 use m_pawcprj,     only : pawcprj_type, pawcprj_alloc, pawcprj_free, pawcprj_put
 use m_paw_dmft,    only : paw_dmft_type
