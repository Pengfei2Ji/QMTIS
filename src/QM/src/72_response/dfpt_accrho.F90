...
!  NB: this is spinor diagonal
     if (option==2.or.option==3) then
       ...
       do i3=1,n3
         do i2=1,n2
           do i1=1,n1
             !FR EB Is there a reason to have vlocal identical for both spins?
             ! TODO: check if this should be:
             !if (isppol==1) then
             ! valuer=valuer+half*(vlocal(i1,i2,i3,1)+vlocal(i1,i2,i3,2))*(wfraug1(1,i1,i2,i3)**2+wfraug1(2,i1,i2,i3)**2)
             !else
             ! valuer=valuer+half*(vlocal(i1,i2,i3,1)-vlocal(i1,i2,i3,2))*(wfraug1(1,i1,i2,i3)**2+wfraug1(2,i1,i2,i3)**2)
             !endif
...
&     weight,weight,use_gpu_cuda=gs_hamkq%use_gpu_cuda)
   ...
   ! EB FR 2nd term in Eq. 91 PRB52,1096 for non-collinear magnetism
     do i3=1,n3
       do i2=1,n2
         do i1=1,n1
! EB FR TODO: this is the analogous formula of the Collinear magnetism: probably not correct even in that case.
!            diag=vlocal(i1,i2,i3,1)*(wfraug1_up(1,i1,i2,i3)**2+wfraug1_up(2,i1,i2,i3)**2)& ! idem to nspden /= 4!
!&                 +vlocal(i1,i2,i3,1)*(wfraug1_down(1,i1,i2,i3)**2+wfraug1_down(2,i1,i2,i3)**2)
           diag=(half*(vlocal(i1,i2,i3,1)+vlocal(i1,i2,i3,2))*(wfraug1_up(1,i1,i2,i3)**2+wfraug1_up(2,i1,i2,i3)**2))+&
&           (half*(vlocal(i1,i2,i3,1)-vlocal(i1,i2,i3,2))*(wfraug1_down(1,i1,i2,i3)**2+wfraug1_down(2,i1,i2,i3)**2))
...
&           (re0_down*re1_down+im0_down*im1_down)) ! real part of rho at k
...
&           re0_down*re1_up+im0_down*im1_up) ! real part of rho at k
...
&           re0_up*im1_down-im0_up*re1_down) ! real part of rho at k
...
&           re0_up*re1_down+im0_down*im1_up)     ! real part of rho at k
