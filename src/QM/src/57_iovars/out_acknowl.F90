...
& ' B.Xue, A.Zhou, J.W.Zwanziger,'//ch10//&
& ' accepted for publication in Computer Phys. Comm. (2016).'
...
& ' Computational Materials Science 25, 478-492 (2002). http://dx.doi.org/10.1016/S0927-0256(02)00325-7'
 comment(4)=' Comment : the original paper describing the ABINIT project.'
 priority(4)=0
...
& ' M. Torrent, F. Jollet, F. Bottin, G. Zerah, and X. Gonze Comput. Mat. Science 42, 337, (2008).'
 comment(14)=' Comment : PAW calculations. Strong suggestion to cite this paper.'
 priority(14)=15
...
& ' Comput. Physics Communications 179, 748 (2008).'
 comment(17)=' Comment : to be cited in case the ETSF_IO file format is used, i.e. iomode=3.'
 priority(17)=20
...
& ' interactions for isomer shifts, i.e. prtfc=1 and usepaw=1.'
 priority(22)=20
...
& '  J. Phys.: Condens. Matter 24 075604 (2012).'
 comment(25)=' Comment : Describes the self-consistent implementation of DFT+DMFT in PAW'
 priority(25)=20
...
& ' Phys. Rev. B 89, 125110 (2014).'
 comment(26)=' Comment : Describes the cRPA implementation of the screened Coulomb interaction in PAW'
 priority(26)=20

 ref(27)= ' Optimized norm-conserving Vanderbilt pseudopotentials.'//ch10//&
& ' D.R. Hamann, Phys. Rev. B 88, 085117 (2013).'
 comment(27)=' Comment: Some pseudopotential generated using the ONCVPSP code were used.'
 priority(27)=3
