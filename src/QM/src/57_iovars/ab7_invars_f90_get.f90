! This file has been automatically generated, do not modify.
  ...
  subroutine ab7_invars_get_integer(dtsetsId, value, id, idtset, errno)
    ...
    case (ab7_invars_gwls_dielectric_model)
      value = token%dtsets(idtset)%gwls_dielectric_model
    case (ab7_invars_cgtyphf)
      value = token%dtsets(idtset)%cgtyphf
    ...
    case (ab7_invars_gwls_sternheimer_kmax)
      value = token%dtsets(idtset)%gwls_sternheimer_kmax
  ...
  subroutine ab7_invars_get_real(dtsetsId, value, id, idtset, errno)
    ...
    case (ab7_invars_gwls_second_model_parameter)
      value = token%dtsets(idtset)%gwls_second_model_parameter
