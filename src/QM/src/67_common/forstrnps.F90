...
!!      init_hamiltonian,load_k_hamiltonian,load_spin_hamiltonian,meanvalue_g
!!      mkffnl,mkkpg,nonlop,pawcprj_alloc,pawcprj_free,pawcprj_get
!!      prep_bandfft_tabs,prep_nonlop,stresssym,timab,xmpi_sum
!!
!! SOURCE
...
!arrays
 ...
 real(dp),allocatable :: gprimd(:,:),kpg_k(:,:),kpg_k_sav(:,:)
...
!usecprj cannot be activated because cprj are not correctly ordered
 usecprj_local=0  !usecprj_local=usecprj
