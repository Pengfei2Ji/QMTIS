...
! **********************************************************************
...
#endif
#if defined HAVE_DFT_WANNIER90_V1
  write(tmp,"(1x,a25)") "HAVE_DFT_WANNIER90_V1"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
...
#endif
#if defined HAVE_TRIO_NETCDF_MPI
  write(tmp,"(1x,a25)") "HAVE_TRIO_NETCDF_MPI"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
  ...
  write(tmp,"(1x,a25)") "HAVE_TRIO_PSML"
  msg = trim(msg)//trim(tmp)
  msg_index = msg_index + 1
  if ( mod(msg_index,3) == 0 ) then
    msg = trim(msg)//ch10
