...
!!
!! COPYRIGHT
!!  Copyright (C) 2010-2016 ABINIT group (Yann Pouillon)
...
&   "-O2 -mtune=native -march=native",ch10,ch10

  write(my_unit,"(1x,a,a,3x,a,a,a)") "Optimizations for 20_datashare:",ch10, &
&   "-O0",ch10,ch10
