...
/* JPF JPF JPF */
    ...
    else if (strcasecmp(token, "fd_Geph_a9")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a9", &fd_Geph_a9, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a8")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a8", &fd_Geph_a8, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a7")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a7", &fd_Geph_a7, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a6")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a6", &fd_Geph_a6, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a5")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a5", &fd_Geph_a5, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a4")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a4", &fd_Geph_a4, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a3")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a3", &fd_Geph_a3, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a2")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a2", &fd_Geph_a2, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a1")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a1", &fd_Geph_a1, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Geph_a0")==0){
      /* electron phonon coupling constant  */
      getparam("fd_Geph_a0", &fd_Geph_a0, PARAM_REAL, 1, 1);
    }
/* JPF JPF JPF */
    ...
    else if (strcasecmp(token, "fd_Ke_Xi")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_Xi", &fd_Ke_Xi, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ke_Eta")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_Eta", &fd_Ke_Eta, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ke_Tf")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_Tf", &fd_Ke_Tf, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ke_Vf")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_Vf", &fd_Ke_Vf, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ke_A")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_A", &fd_Ke_A, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ke_B")==0){
      /* FD electronic heat conductivity  */
      getparam("fd_Ke_B", &fd_Ke_B, PARAM_REAL, 1, 1);
    }
...
/* JPF JPF JPF */
    ...
    else if (strcasecmp(token, "fd_Ce_a0")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a0", &fd_Ce_a0, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a1")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a1", &fd_Ce_a1, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a2")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a2", &fd_Ce_a2, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a3")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a3", &fd_Ce_a3, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a4")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a4", &fd_Ce_a4, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a5")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a5", &fd_Ce_a5, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a6")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a6", &fd_Ce_a6, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a7")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a7", &fd_Ce_a7, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a8")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a8", &fd_Ce_a8, PARAM_REAL, 1, 1);
    }
    else if (strcasecmp(token, "fd_Ce_a9")==0){
      /* FD electronic heat capacity / T_e (proport. const.) */
      getparam("fd_Ce_a9", &fd_Ce_a9, PARAM_REAL, 1, 1);
    }
/* JPF JPF JPF */
...
*/
/* if ((fd_Ce_a4==0.0 && fd_Ce_a3==0.0 fd_Ce_a2==0.0 && fd_Ce_a1==0.0 && fd_Ce_a0==0.0 && fd_c==0.0)||(fd_Ce_a4!=0.0 && fd_Ce_a3!=0.0 fd_Ce_a2!=0.0 && fd_Ce_a1!=0.0 && fd_Ce_a0!=0.0 && fd_c!=0.0)) {
    error ("You must specify either fd_Ce_ax or fd_c for TTM simulations.");
  }
*/
...
void broadcast_params() {
 ...
 MPI_Bcast( &flagedatomstype,         1, MPI_INT,  0, MPI_COMM_WORLD);
  ...
  MPI_Bcast( &fd_Geph_a9,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a8,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a7,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a6,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a5,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a4,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a3,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a2,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a1,     1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Geph_a0,     1, REAL,    0, MPI_COMM_WORLD);
  ...
  MPI_Bcast( &fd_Ce_a9,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a8,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a7,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a6,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a5,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a4,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a3,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a2,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a1,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ce_a0,	      1, REAL,	  0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_k,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_Eta,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_Xi,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_Tf,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_A,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_B,           1, REAL,    0, MPI_COMM_WORLD);
  MPI_Bcast( &fd_Ke_Vf,           1, REAL,    0, MPI_COMM_WORLD);
