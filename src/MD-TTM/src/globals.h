...
/* Electron Thermal Conductivity from Most of MTT Papers */
EXTERN real fd_Ke_Xi INIT(1.0); /* electronic thermal conductivity */
EXTERN real fd_Ke_Eta INIT(1.0); /* electronic thermal conductivity */
EXTERN real fd_Ke_Tf INIT(1.0); /* electronic thermal conductivity */
/* Electron Thermal Conductivity from Drude Model */ 
EXTERN real fd_Ke_Vf INIT(1.0); /* electronic thermal conductivity */
EXTERN real fd_Ke_A INIT(1.0); /* electronic thermal conductivity */
EXTERN real fd_Ke_B INIT(1.0); /* electronic thermal conductivity */
/* ###################################################### */
EXTERN real fd_c INIT(0.0); /* electronic thermal capacity */
/* JPF JPF JPF */
EXTERN real fd_gamma INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a0 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a1 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a2 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a3 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a4 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a5 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a6 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a7 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a8 INIT(0.0); /* fd_c / T_e, proport. const. */
EXTERN real fd_Ce_a9 INIT(0.0); /* fd_c / T_e, proport. const. */
/* JPF JPF JPF */
EXTERN real fd_g INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a0 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a1 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a2 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a3 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a4 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a5 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a6 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a7 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a8 INIT(1.0);        /* electron-phonon coupling constant */
EXTERN real fd_Geph_a9 INIT(1.0);        /* electron-phonon coupling constant */
/* JPF JPF JPF */
