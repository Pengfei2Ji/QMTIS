...
/* #define FD_Ce (fd_gamma*l1[i][j][k].temp) */
#define FD_Ce ( fd_Ce_a9*pow(l1[i][j][k].temp,9) + fd_Ce_a8*pow(l1[i][j][k].temp,8) + fd_Ce_a7*pow(l1[i][j][k].temp,7) + fd_Ce_a6*pow(l1[i][j][k].temp,6) + fd_Ce_a5*pow(l1[i][j][k].temp,5) + fd_Ce_a4*pow(l1[i][j][k].temp,4) + fd_Ce_a3*pow(l1[i][j][k].temp,3) + fd_Ce_a2*pow(l1[i][j][k].temp,2) + fd_Ce_a1*pow(l1[i][j][k].temp,1) + fd_Ce_a0 )

/* Macro to allow Ele-Pho coupling factor to vary with Te */
#define FD_Geph (fd_Geph_a9*pow(l1[i][j][k].temp,9) + fd_Geph_a8*pow(l1[i][j][k].temp,8) + fd_Geph_a7*pow(l1[i][j][k].temp,7) + fd_Geph_a6*pow(l1[i][j][k].temp,6) + fd_Geph_a5*pow(l1[i][j][k].temp,5) + fd_Geph_a4*pow(l1[i][j][k].temp,4) + fd_Geph_a3*pow(l1[i][j][k].temp,3) + fd_Geph_a2*pow(l1[i][j][k].temp,2) + fd_Geph_a1*pow(l1[i][j][k].temp,1) + fd_Geph_a0 )
/* #define FD_Geph (fd_g*( (fd_Ke_A/fd_Ke_B) * (l1[i][j][k].temp + l1[i][j][k].md_temp) + 1) ) */
/* #define FD_Geph (fd_g) */

/* Macro to allow electron thermal condutivity to vary with Te */
/* MTT lab */
/* #define FD_Ke (fd_Ke_Xi*( (pow( (pow( (l1[i][j][k].temp/fd_Ke_Tf), 2) + 0.16), 1.25) * ( pow( (l1[i][j][k].temp/fd_Ke_Tf), 2) + 0.44) * (l1[i][j][k].temp/fd_Ke_Tf) ) / (pow( (pow( (l1[i][j][k].temp/fd_Ke_Tf), 2) + 0.092), 0.5) * ( pow( (l1[i][j][k].temp/fd_Ke_Tf), 2) + fd_Ke_Eta*(l1[i][j][k].md_temp/fd_Ke_Tf) ) ) ) ) */
/* Drude theory */
/* #define FD_Ke ( pow(fd_Ke_Vf,2) * FD_Ce / (fd_Ke_A*pow(l1[i][j][k].temp,2) + fd_Ke_B*l1[i][j][k].md_temp) / 3.0 )  */
/* #define FD_Ke ( pow(fd_Ke_Vf,2) * (fd_gamma*l1[i][j][k].temp) / (fd_Ke_A*pow(l1[i][j][k].temp,2) + fd_Ke_B*l1[i][j][k].md_temp) / 3.0 )  */
/* Constant Constant */
#define FD_Ke (fd_k)
...
/*	                 (0.5*fd_gamma*SQR(l1[i][j][k].temp)):  */
                      (
                        0.1000*fd_Ce_a9*pow(l1[i][j][k].temp,10) +
                        0.1111*fd_Ce_a8*pow(l1[i][j][k].temp,9) +
                        0.1250*fd_Ce_a7*pow(l1[i][j][k].temp,8) +
                        0.1429*fd_Ce_a6*pow(l1[i][j][k].temp,7) +
                        0.1667*fd_Ce_a5*pow(l1[i][j][k].temp,6) +
                        0.2000*fd_Ce_a4*pow(l1[i][j][k].temp,5) +
                        0.2500*fd_Ce_a3*pow(l1[i][j][k].temp,4) +
                        0.3333*fd_Ce_a2*pow(l1[i][j][k].temp,3) +
                        0.5000*fd_Ce_a1*pow(l1[i][j][k].temp,2) +
                               fd_Ce_a0*pow(l1[i][j][k].temp,1)
                      ):
...
void init_ttm()
{
		      ...
		      which will remain fixed, too */
  {
    ...
    ttm_eng = init_t_el * 
              global_fd_dim.x * global_fd_dim.y * global_fd_dim.z *
              ((fd_c==0)?
/*               (0.5*fd_gamma*init_t_el):  */
                      (
                        0.1000*fd_Ce_a9*pow(init_t_el,10) +
                        0.1111*fd_Ce_a8*pow(init_t_el,9) +
                        0.1250*fd_Ce_a7*pow(init_t_el,8) +
                        0.1429*fd_Ce_a6*pow(init_t_el,7) +
                        0.1667*fd_Ce_a5*pow(init_t_el,6) +
                        0.2000*fd_Ce_a4*pow(init_t_el,5) +
                        0.2500*fd_Ce_a3*pow(init_t_el,4) +
                        0.3333*fd_Ce_a2*pow(init_t_el,3) +
                        0.5000*fd_Ce_a1*pow(init_t_el,2) +
                               fd_Ce_a0*pow(init_t_el,1)
                      ):
...
/*		- 1.0/FD_Ce * fd_g * ( l1[i][j][k].temp - l1[i][j][k].md_temp )  */
		- 1.0/FD_Ce * FD_Geph * ( l1[i][j][k].temp - l1[i][j][k].md_temp )\
		+ 1.0/FD_Ce * l1[i][j][k].source )
	      + l1[i][j][k].temp;
