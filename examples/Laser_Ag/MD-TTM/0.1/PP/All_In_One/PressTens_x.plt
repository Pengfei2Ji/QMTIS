...
set zlabel "Stress [GPa]"

set output "Presstens_x.ps"
...
splot "Gnuplot_Output.dat" using ($1*0.5):($2*13.85/320.00):($4) with p pointtype 5 pointsize 1 palette linewidth 100 notitle
